...
public class EndpointIndexBuilder {
	...
	private static void buildEndpointIndex() {
		...
		endpointIndex.put(RequestType.APP_FRIENDS, BASE_URL + "application/friends");
		...
		endpointIndex.put(RequestType.WALL_RICHPOST, BASE_URL + "wall/");
	...
	private static void buildMethodIndex() {
		...
		methodIndex.put(RequestType.WALL_RICHPOST, RequestMethod.POST);
